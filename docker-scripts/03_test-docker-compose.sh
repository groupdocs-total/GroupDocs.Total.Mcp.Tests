#!/bin/bash
################################################################################
# GroupDocs.Total.Mcp — Docker-Compose Integration Test Runner
#
...
TEST_PROJECT_DIR="$PROJECT_ROOT/src/GroupDocs.Total.Mcp.Tests"
...
services:
  test-runner:
    ...
    working_dir: /workspace/src/GroupDocs.Total.Mcp.Tests
    environment:
      DOTNET_NOLOGO: "true"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Total.Mcp — Docker Test Runner      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""
