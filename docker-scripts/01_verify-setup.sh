...
main() {
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Total.Mcp — Setup Verification      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""
    ...
    # Check test project
    if [ -d "$PROJECT_ROOT/src/GroupDocs.Total.Mcp.Tests" ]; then
        print_pass "Test project found"
    else
        print_fail "Test project not found: $PROJECT_ROOT/src/GroupDocs.Total.Mcp.Tests"
    fi
    
    # Check csproj
    if [ -f "$PROJECT_ROOT/src/GroupDocs.Total.Mcp.Tests/GroupDocs.Total.Mcp.Tests.csproj" ]; then
    ...
    local mcp_image="ghcr.io/groupdocs-total/total-net-mcp:latest"
