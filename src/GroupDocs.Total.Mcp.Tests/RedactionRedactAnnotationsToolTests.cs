...
public class RedactionRedactAnnotationsToolTests
{
    ...
    public RedactionRedactAnnotationsToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task RedactionRedactAnnotations_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("RedactionRedactAnnotations");
