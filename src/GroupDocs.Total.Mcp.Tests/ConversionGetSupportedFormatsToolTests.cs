...
public class ConversionGetSupportedFormatsToolTests
{
    ...
    public ConversionGetSupportedFormatsToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task ConversionGetSupportedFormats_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("ConversionGetSupportedFormats");
