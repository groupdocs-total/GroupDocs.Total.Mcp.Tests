...
public class SignatureSearchImageSignaturesToolTests
{
    ...
    public SignatureSearchImageSignaturesToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task SignatureSearchImageSignatures_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("SignatureSearchImageSignatures");
