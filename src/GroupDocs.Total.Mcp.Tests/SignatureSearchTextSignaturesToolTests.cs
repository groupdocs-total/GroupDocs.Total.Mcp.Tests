...
public class SignatureSearchTextSignaturesToolTests
{
    ...
    public SignatureSearchTextSignaturesToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task SignatureSearchTextSignatures_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("SignatureSearchTextSignatures");
