...
public class AnnotationRemoveRepliesToolTests
{
    ...
    public AnnotationRemoveRepliesToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task AnnotationRemoveReplies_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("AnnotationRemoveReplies");
