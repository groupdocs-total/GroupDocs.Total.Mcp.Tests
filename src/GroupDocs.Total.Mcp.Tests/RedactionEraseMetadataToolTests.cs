...
public class RedactionEraseMetadataToolTests
{
    ...
    public RedactionEraseMetadataToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task RedactionEraseMetadata_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("RedactionEraseMetadata");
