...
public class AnnotationAddAnnotationToolTests
{
    ...
    public AnnotationAddAnnotationToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task AnnotationAddAnnotation_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("AnnotationAddAnnotation");
