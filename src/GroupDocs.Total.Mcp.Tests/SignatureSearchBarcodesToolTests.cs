...
public class SignatureSearchBarcodesToolTests
{
    ...
    public SignatureSearchBarcodesToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task SignatureSearchBarcodes_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("SignatureSearchBarcodes");
