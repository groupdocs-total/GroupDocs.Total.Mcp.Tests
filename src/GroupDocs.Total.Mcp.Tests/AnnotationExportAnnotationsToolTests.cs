...
public class AnnotationExportAnnotationsToolTests
{
    ...
    public AnnotationExportAnnotationsToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task AnnotationExportAnnotations_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("AnnotationExportAnnotations");
