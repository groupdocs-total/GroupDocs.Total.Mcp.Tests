...
public class WatermarkAddWatermarkToolTests
{
    ...
    public WatermarkAddWatermarkToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task WatermarkAddWatermark_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("WatermarkAddWatermark");
