...
public class WatermarkSearchWatermarksToolTests
{
    ...
    public WatermarkSearchWatermarksToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task WatermarkSearchWatermarks_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("WatermarkSearchWatermarks");
