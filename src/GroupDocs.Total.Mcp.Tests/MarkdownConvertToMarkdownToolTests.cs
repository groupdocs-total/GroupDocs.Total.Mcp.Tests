...
public class MarkdownConvertToMarkdownToolTests
{
    ...
    public MarkdownConvertToMarkdownToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task MarkdownConvertToMarkdown_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("MarkdownConvertToMarkdown");
