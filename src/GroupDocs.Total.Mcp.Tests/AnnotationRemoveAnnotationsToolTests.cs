...
public class AnnotationRemoveAnnotationsToolTests
{
    ...
    public AnnotationRemoveAnnotationsToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task AnnotationRemoveAnnotations_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("AnnotationRemoveAnnotations");
