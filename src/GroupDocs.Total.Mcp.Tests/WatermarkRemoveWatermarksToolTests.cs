...
public class WatermarkRemoveWatermarksToolTests
{
    ...
    public WatermarkRemoveWatermarksToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task WatermarkRemoveWatermarks_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("WatermarkRemoveWatermarks");
