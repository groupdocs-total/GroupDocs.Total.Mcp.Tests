...
public class SignatureSearchDigitalSignaturesToolTests
{
    ...
    public SignatureSearchDigitalSignaturesToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task SignatureSearchDigitalSignatures_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("SignatureSearchDigitalSignatures");
