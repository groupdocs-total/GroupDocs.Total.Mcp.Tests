...
public class MetadataRemoveMetadataToolTests
{
    ...
    public MetadataRemoveMetadataToolTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task MetadataRemoveMetadata_SmokeCall_ReturnsResponseAndDoesNotCrashServer()
    {
        var catalog = await ToolCatalog.LoadAsync(_fixture.Client);
        var tool = catalog.ByName("MetadataRemoveMetadata");
