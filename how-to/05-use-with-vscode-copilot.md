...
2. Open Copilot chat.
3. Click the tools / MCP icon — `groupdocs-total` should appear with
   all 38 Total tools listed (cross-product GetDocumentInfo / GetDocumentPageImage + Annotation* / Signature* / Comparison* / Conversion* / Markdown* / Merger* / Metadata* / Parser* / Redaction* / Watermark*).
...
The [NuGet.org package page](https://www.nuget.org/packages/GroupDocs.Total.Mcp)
